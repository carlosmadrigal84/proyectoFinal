...
export class UploadProductPage extends Component {
    ...
    handleChangeWallathings = (event) => {
        this.setState({ wallathings: event.currentTarget.value })
    }
    ...
    onSubmit = (event) => {
        ...
        if (!this.state.title || !this.state.description ||
            !this.state.wallathings || !this.state.images
            || !this.state.price) {
        ...
        const variables = {
            ...
            wallathings: this.state.wallathings,
        ...
        return (
            ...
            <Form onSubmit={this.onSubmit}>
               ...
               <FileUpload refreshFunction={this.updateFiles} />
                ...
                />
                <br /><br />
                <select onChange={this.handleChangeWallathings}>
                    {Continents.map(item => (
